...
namespace ClientDataBase
{
    public class ClientDataBaseManager : Singleton<ClientDataBaseManager>
    {
        ...
        public ClientDataBaseConfig Config
        {
            ...
            {
                if (m_config == null)
                    m_config = Utilities.AssetRelate.ResourcesLoadCheckNull<ClientDataBaseConfig>(PATH_CONFIG);
        ...
        {
            return Utilities.AssetRelate.ResourcesLoadCheckNull<ScriptableObjectBase>(PATH_SCRIPTABLE_ASSET_ROOT + Config.GetScriptableAssetNameFromType(type));
        }
